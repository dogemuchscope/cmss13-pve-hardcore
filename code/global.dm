...
#define MAIN_SHIP_DEFAULT_NAME "USS Queequeg"
#define SHIP_MAP_NAMES list("USS Almayer", "USS Queequeg",  "USS Queequeg (Classic)", "SSV Chapaev", "USS Rover", "USCSS Firefly")
